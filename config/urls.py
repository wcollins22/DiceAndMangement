...
urlpatterns = [
    ...
    path("update_stats_m/<str:pk>/", views.updateMonsterStats, name="updatem_stats"),
    path("update_stats_c/<str:pk>/", views.updateCharacter, name="updatec_stats"),
    ...
    path('random_monster', views.random_monsters, name='randomm')
